    ...
    <Card className="p-4 mb-6 pwa-dashboard-card">
      <div className="pwa-dashboard-card__content">
        ...
        <div className="min-w-0 flex-1">
          <p className="font-display font-bold text-sm" style={{ color: 'var(--color-ink)' }}>{t('pwa.cardTitle')}</p>
          <p className="text-xs mt-0.5" style={{ color: 'var(--color-muted)' }}>{t('pwa.cardText', { role: roleLabel })}</p>
        </div>
        <PWAInstallButton />
      </div>
    </Card>
