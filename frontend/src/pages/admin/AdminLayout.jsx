...
const navItems = [
  ...
  { to: '/admin/kengaytirilgan-statistika', label: 'Kuchli statistika', mobileLabel: 'Statistika', icon: BarChart3 },
  { to: '/admin/musobaqalar', label: 'Musobaqalar', mobileLabel: 'Reyting', icon: Trophy },
