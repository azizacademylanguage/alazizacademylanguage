...
export const saveDarsProgress = (darsId, data) => client.post(`/oquvchi/dars/${darsId}/progress/`, data, { offlineQueue: true, offlineQueueKind: 'lesson-progress' }).then(r => r.data);

export const getMashq = (mashqId) => client.get(`/oquvchi/mashq/${mashqId}/`).then(r => r.data);
export const topshirMashq = (mashqId, javoblar) =>
  client.post(`/oquvchi/mashq/${mashqId}/topshirish/`, { javoblar }, { offlineQueue: true, offlineQueueKind: 'exercise-result' }).then(r => r.data);
