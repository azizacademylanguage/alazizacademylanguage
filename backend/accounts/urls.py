...
from .content_excel import ContentExcelExportView, ContentExcelImportView
...
urlpatterns = [
    ...
    path('admin/content/export.xlsx', ContentExcelExportView.as_view(), name='content-excel-export'),
    path('admin/content/import-xlsx/', ContentExcelImportView.as_view(), name='content-excel-import'),
    path('admin/backup/download/', BackupDownloadView.as_view(), name='backup-download'),
    path('admin/backup/restore/', BackupRestoreView.as_view(), name='backup-restore'),
] + router.urls
